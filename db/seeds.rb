...
Trainer.create(name: "Joey", level: rand(100), img_url: "#", id:"500")
Trainer.create(name: "Mary", level: rand(100), img_url: "#", id:"501")
Trainer.create(name: "Chloe", level: rand(100), img_url: "#", id:"502")
Trainer.create(name: "Larry", level: rand(100), img_url: "#", id:"503")
